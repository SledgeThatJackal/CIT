                ...
                <tbody class="table-group-divider">
                    {containerData.map((container) => (
                        <tr key={container.id}>
                            ...
                            <td><button type="button" onClick={() => setDeleteId(`${container.id}`)} className="btn btn-danger btn-small" data-bs-toggle="modal" data-bs-target="#containerConfirmationModal">Delete</button></td>
                        </tr>
                    ))}
                </tbody>
            </table>
